...
export const supportedThemes = ['auto', 'light', 'dark'];
 ...
 */
export function initThemeTransitionOverlay() {
 ...
 */
export function applyThemeChange(theme) {
    if (theme === 'auto') {
 ...
 */
export function applyThemePreference(themeChoice, save = true) {
 ...
 */
export function updateAutoThemeOnSystemChange() {
 ...
 */
export function applyThemeBasedImage(img) {
 ...
 */
export function applyAllThemeBasedImages() {
    try {
 ...
 */
export function applyFaviconTheme(link) {
 ...
 */
export function applyAllFaviconThemes() {
    try {
 ...
 */
export function getThemeI18nKey(theme) {
 ...
 */
export function setActiveThemeItem() {
 ...
 * @param {string} themeChoice - One of 'auto', 'light', or 'dark'.
 */
export function setThemePreference(themeChoice) {
