...
Handled by `applyAllThemeBasedImages()` in `theme.ts` (see [§4.4 Theme System](4-theme-system.md#44-theme-system)).
...
**Interaction with Theme System** ([§4.4](4-theme-system.md#44-theme-system)):
