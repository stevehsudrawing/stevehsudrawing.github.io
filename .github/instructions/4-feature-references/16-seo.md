...
| JSON-LD (inline)          | ✓ See [§4.16.2](16-seo.md#4162-structured-data-json-ld) | ✗                 | ✗                    |
...
- The Page Transition System ([§4.6](6-page-transitions.md#46-page-transitions)) preserves the `?lang=` parameter across internal SPA navigations, so the user's chosen language persists through page transitions.
