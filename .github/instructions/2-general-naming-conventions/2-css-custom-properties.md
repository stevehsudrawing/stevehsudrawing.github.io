...
- **Color variables** - naming and brightness scale defined in [§4.4 Theme System](../4-feature-references/4-theme-system.md).
- **Font variables** - naming, categories, priorities, and languages defined in [§4.11 Fonts & Typography](../4-feature-references/11-fonts-typography.md).
